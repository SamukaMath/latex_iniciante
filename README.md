...
- Introduzir os conceitos fundamentais do LaTeX.  
- Ensinar a estrutura básica de um documento.  
- Apresentar comandos para formatação de textos, listas, figuras, tabelas e equações.  
